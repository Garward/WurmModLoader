...
class ActionPerformerChain implements ActionPerformerBase {
	...
	/**
	 * ThreadLocal to detect and prevent infinite recursion in action chains.
	 * Tracks the recursion depth for this specific action chain on the current thread.
	 */
	private static final ThreadLocal<Integer> recursionDepth = ThreadLocal.withInitial(() -> 0);

	/**
	 * Maximum allowed recursion depth before we stop to prevent stack overflow.
	 */
	...
	public boolean action(Action action, Creature performer, Item source, int tilex, int tiley, boolean onSurface, boolean corner, int tile, int heightOffset, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, tilex, tiley, onSurface, corner, tile, heightOffset, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, int tilex, int tiley, boolean onSurface, boolean corner, int tile, int heightOffset, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, tilex, tiley, onSurface, corner, tile, heightOffset, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, int tilex, int tiley, boolean onSurface, int tile, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, tilex, tiley, onSurface, tile, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, int tilex, int tiley, boolean onSurface, int heightOffset, int tile, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, tilex, tiley, onSurface, heightOffset, tile, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, int planetId, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, planetId, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, int planetId, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, planetId, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, Item target, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, target, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Wound target, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, target, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, boolean onSurface, Fence target, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, onSurface, target, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, boolean onSurface, Fence target, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, onSurface, target, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, Skill skill, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, skill, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Skill skill, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, skill, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, boolean onSurface, Floor target, int encodedTile, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, onSurface, target, encodedTile, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, boolean onSurface, Floor floor, int encodedTile, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, onSurface, floor, encodedTile, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, int tilex, int tiley, boolean onSurface, int heightOffset, Tiles.TileBorderDirection dir, long borderId, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, tilex, tiley, onSurface, heightOffset, dir, borderId, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, int tilex, int tiley, boolean onSurface, Tiles.TileBorderDirection dir, long borderId, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, tilex, tiley, onSurface, dir, borderId, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item[] targets, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, targets, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, boolean onSurface, BridgePart bridgePart, int encodedTile, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, onSurface, bridgePart, encodedTile, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item item, boolean onSurface, BridgePart bridgePart, int encodedTile, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, item, onSurface, bridgePart, encodedTile, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, int tilex, int tiley, boolean onSurface, boolean corner, int tile, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, tilex, tiley, onSurface, corner, tile, 0, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, int tilex, int tiley, boolean onSurface, boolean corner, int tile, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, tilex, tiley, onSurface, corner, tile, 0, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, int tilex, int tiley, boolean onSurface, int tile, int dir, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, tilex, tiley, onSurface, tile, dir, num, counter);
	}
	...
	public boolean action(Action action, Creature performer, Item source, int tilex, int tiley, boolean onSurface, int heightOffset, int tile, int dir, short num, float counter) {
		WrappedBehaviour wrapped = wrap(action); if (wrapped == null) return false; return wrapped.action(action, performer, source, tilex, tiley, onSurface, heightOffset, tile, dir, num, counter);
	}
	...
	private WrappedBehaviour wrap(Action action) {
		// Check for recursion before creating WrappedBehaviour
		int depth = recursionDepth.get();

		if (depth >= MAX_RECURSION_DEPTH) {
			// Prevent stack overflow by stopping recursion
			// Log a warning and return the original behaviour unwrapped
			System.err.println("WARNING: ActionPerformerChain detected infinite recursion (depth=" + depth + ") for action " + actionId + ". Stopping to prevent stack overflow.");
			recursionDepth.set(0); // Reset for next call
			return null; // Return null to signal we should use fallback behavior
		}
		...
		try {
			...
			// Create wrapped behaviour
			return new WrappedBehaviour(action.getBehaviour(), WrappedBehaviour.getDefaultActionReturnValue(action), actionPerformers);
		} finally {
			// Always decrement depth when we exit (even if exception thrown)
			recursionDepth.set(Math.max(0, recursionDepth.get() - 1));
		}
	}
