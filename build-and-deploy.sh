#!/usr/bin/env bash
#
# WurmModLoader Build and Deploy Script
...
echo -e "${CYAN}======================================================================${NC}"
echo -e "${CYAN}🤖 WurmModLoader: Full Build & Deploy Automation${NC}"
echo -e "${CYAN}======================================================================${NC}"
echo ""
...
# Step 2: Deploy
echo -e "${BLUE}[2/2]${NC} ${YELLOW}Deploying to server...${NC}"
echo ""
...
if ./deploy.sh; then
    ...
    echo ""
    echo -e "${YELLOW}Your mods are ready to test!${NC}"
    echo ""
    exit 0
else
    echo ""
