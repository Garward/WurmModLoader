...
public class ModCreatures {
	...
	public static void init() {
		...
		// CRITICAL: Add Creature callback FIRST, before any other callbacks that reference Creature in their signatures
		// This prevents Creature from being frozen when processing GmSetTraitsCallbacks.getTraitString(Creature, int)
		try {
		...
		// Add GmSetTraits callback AFTER Creature callback (Creature is now frozen, but that's OK)
		try {
			/**
