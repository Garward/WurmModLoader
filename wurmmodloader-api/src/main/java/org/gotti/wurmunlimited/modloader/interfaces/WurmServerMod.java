 ...
 * <p>
 * This interface now extends the new WurmServerMod interface to unify both old and new mods
 ...
 * </p>
 *
 * @deprecated Use {@link com.garward.wurmmodloader.modloader.interfaces.WurmServerMod} for new mods
 */
@Deprecated
public interface WurmServerMod extends com.garward.wurmmodloader.modloader.interfaces.WurmServerMod, Versioned {
	// All methods inherited from modern interface
	// Explicitly extends legacy Versioned for ModLoaderShared type bounds compatibility
}
