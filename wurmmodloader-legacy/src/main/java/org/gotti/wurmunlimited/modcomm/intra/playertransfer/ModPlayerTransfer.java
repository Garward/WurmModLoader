...
public class ModPlayerTransfer {
	...
	private void initClassHooks() {
		try {
			...
			ctCreatePlayerData.insertBefore("modPlayerTransfer.setTargetServer($4);");
			...
			ctSendMailSetToServer.insertBefore("modPlayerTransfer.setTargetServer($3);");
